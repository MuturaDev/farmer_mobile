...
import com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.permissionprovider.StubPermissionProvider;
...
public class LocationConfiguration {
    ...
    public com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.LocationConfiguration.Builder newBuilder() {
        return new com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.LocationConfiguration.Builder()
    ...
    public static class Builder {
        ...
        public com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.LocationConfiguration build() {
            ...
            return new com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.LocationConfiguration(this);
        }
