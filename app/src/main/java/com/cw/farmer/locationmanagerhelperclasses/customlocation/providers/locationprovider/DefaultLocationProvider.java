...
import com.cw.farmer.locationmanagerhelperclasses.customlocation.helper.continuoustask.ContinuousTask.ContinuousTaskRunner;
import com.cw.farmer.locationmanagerhelperclasses.customlocation.listener.DialogListener;
...
public class DefaultLocationProvider extends LocationProvider
    ...
    private com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.locationprovider.DefaultLocationSource defaultLocationSource;
    ...
    public void runScheduledTask(@NonNull String taskId) {
        if (taskId.equals(com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.locationprovider.DefaultLocationSource.PROVIDER_SWITCH_TASK)) {
            getSourceProvider().getUpdateRequest().release();
    ...
    // For test purposes
    void setDefaultLocationSource(com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.locationprovider.DefaultLocationSource defaultLocationSource) {
        this.defaultLocationSource = defaultLocationSource;
    }

    private com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.locationprovider.DefaultLocationSource getSourceProvider() {
        if (defaultLocationSource == null) {
            defaultLocationSource = new com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.locationprovider.DefaultLocationSource(getContext(), this, this);
        }
