package com.cw.farmer.locationmanagerhelperclasses.customlocation.view;
...
public class ContextProcessor {
     ...
     */
    public com.cw.farmer.locationmanagerhelperclasses.customlocation.view.ContextProcessor setActivity(Activity activity) {
     ...
     */
    public com.cw.farmer.locationmanagerhelperclasses.customlocation.view.ContextProcessor setFragment(Fragment fragment) {
        weakActivity = new WeakReference<>(null);
