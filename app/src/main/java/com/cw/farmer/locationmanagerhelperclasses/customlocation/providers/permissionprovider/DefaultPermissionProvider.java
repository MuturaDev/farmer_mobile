...
public class DefaultPermissionProvider extends PermissionProvider implements DialogListener {
    ...
    private com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.permissionprovider.PermissionCompatSource permissionCompatSource;
    ...
    // For test purposes
    void setPermissionCompatSource(com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.permissionprovider.PermissionCompatSource permissionCompatSource) {
        this.permissionCompatSource = permissionCompatSource;
    }

    protected com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.permissionprovider.PermissionCompatSource getPermissionCompatSource() {
        if (permissionCompatSource == null) {
            permissionCompatSource = new com.cw.farmer.locationmanagerhelperclasses.customlocation.providers.permissionprovider.PermissionCompatSource();
        }
