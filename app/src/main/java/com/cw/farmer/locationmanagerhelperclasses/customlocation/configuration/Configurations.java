...
public final class Configurations {
     ...
     * see also {@linkplain com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.Configurations#silentConfiguration(boolean)}
     */
     ...
     * LocationManager will call {@linkplain (int)} silently
     *
