...
public class GooglePlayServicesConfiguration {
    ...
    public com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.GooglePlayServicesConfiguration.Builder newBuilder() {
        return new com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.GooglePlayServicesConfiguration.Builder()
    ...
    public static class Builder {
        ...
        public com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.GooglePlayServicesConfiguration build() {
            return new com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.GooglePlayServicesConfiguration(this);
        }
    }
}
