...
public final class Defaults {
    ...
    public static LocationRequest createDefaultLocationRequest() {
        return LocationRequest.create()
              .setPriority(com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.Defaults.LOCATION_PRIORITY)
              .setInterval(com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.Defaults.LOCATION_INTERVAL)
              .setFastestInterval(com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.Defaults.LOCATION_FASTEST_INTERVAL);
    }
