...
import com.cw.farmer.locationmanagerhelperclasses.customlocation.constants.ProviderType;
...
public class DefaultProviderConfiguration {
    ...
    public static class Builder {
         ...
         * Because {@linkplain com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.DefaultProviderConfiguration.Builder#gpsMessage} will be ignored in that case.
         *
         * If you don't specify any dialogProvider implementation {@linkplain SimpleMessageDialogProvider} will be used with
         * given {@linkplain com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.DefaultProviderConfiguration.Builder#gpsMessage}
         */
        ...
        public DefaultProviderConfiguration build() {
            ...
            return new com.cw.farmer.locationmanagerhelperclasses.customlocation.configuration.DefaultProviderConfiguration(this);
        }
    }
}
