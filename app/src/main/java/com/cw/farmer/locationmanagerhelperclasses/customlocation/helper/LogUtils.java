package com.cw.farmer.locationmanagerhelperclasses.customlocation.helper;
...
public final class LogUtils {
    ...
    public static void enable(boolean isEnabled) {
        com.cw.farmer.locationmanagerhelperclasses.customlocation.helper.LogUtils.isEnabled = isEnabled;
    }
