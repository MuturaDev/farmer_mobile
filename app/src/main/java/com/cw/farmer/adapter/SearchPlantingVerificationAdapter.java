...
public class SearchPlantingVerificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchPlantingVerificationAdapter(RecyclerView recyclerView, Context context, ArrayList<PageItemsPlantVerify> pageItemArrayList) {
    ...
    public void setdata(ArrayList<PageItemsPlantVerify> feedDataArrayList) {
...
//    }
    ...
    private void populateItemRows(ViewHolder viewHolder, int position) {
        final PageItemsPlantVerify pageItem = pageItemArrayList.get(position);
        String date="";
        for(int elem : pageItem.getPlantingDate()){
            date=elem+"/"+date;
        }
        String contractdate="";
        for(int elem : pageItem.getPlantingDate()){
        ...
        viewHolder.tv_mobile.setText("Contract Id: "+pageItem.getContractId());
        viewHolder.tv_idno.setText("ID No: "+pageItem.getFarmerIdNo());
        ...
        viewHolder.lin_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, PlantingVerificationActivity.class);
                intent.putExtra("name",pageItem.getFarmerName());
                intent.putExtra("farmerId",pageItem.getFarmerId()+"");
                intent.putExtra("contractId",pageItem.getContractId()+"");
                intent.putExtra("crop_date",removeLastChar(finalDate)+"");
                intent.putExtra("contractNo",pageItem.getContractNo()+"");
                intent.putExtra("plantingId",pageItem.getPlantingId()+"");
                intent.putExtra("idno",pageItem.getFarmerIdNo()+"");
                intent.putExtra("centreName",pageItem.getCentreName()+"");
                intent.putExtra("accountNo",pageItem.getAccountNo()+"");
                intent.putExtra("nounits",pageItem.getNounits()+"");
                context.startActivity(intent);
            }
        });
